...
def create_dict(file_list, prefix_pattern):
    ...
    for file_path in file_list:
        ...
        file_name = os.path.basename(file_path)  # 'votacoes_2007_03_04.json'
        
        # remove prefixo e sufixo
        if file_name.startswith(prefix_pattern) and file_name.endswith(".json"):
            dict_key = file_name[len(prefix_pattern):-len(".json")]  # '2007_03_04'
...
# TODO: Todas as leituras de JSON RAW files podem ser feitas de forma praticamente igual
